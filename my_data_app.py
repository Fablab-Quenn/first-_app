...
#la fonction markdown permet d'ajouter du contenues texte dans une application
st.markdown("""
...
#la fonction load nous permet de cree un bouttons et de jouer sur le dataframe.
